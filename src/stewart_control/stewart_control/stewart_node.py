...
class StewartNode(Node):
    def __init__(self):
        ...
        # Subscribers
        self.imu_subscription = self.create_subscription(Float32MultiArray, 'imu_error', self.imu_callback, 10)
        self.pos_subscription = self.create_subscription(Float32MultiArray, 'aruco_position', self.position_callback, 10)
        self.ori_subscription = self.create_subscription(Float32MultiArray, 'aruco_orientation', self.orientation_callback, 10)
